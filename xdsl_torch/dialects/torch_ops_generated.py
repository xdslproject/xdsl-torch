...
class Torch_AtenSet_SourceTensorOp(IRDLOperation):
    ...
    self = operand_def(AnyTensorTypeConstr)
    source = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
...
class Torch_AtenMaskedSelectOp(IRDLOperation):
    ...
    self = operand_def(AnyTensorTypeConstr)
    mask = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
    assembly_format = (
...
class Torch_Aten_NestedViewFromBufferOp(IRDLOperation):
    ...
    self = operand_def(AnyTensorTypeConstr)
    nested_size = operand_def(AnyTensorTypeConstr)
    nested_strides = operand_def(AnyTensorTypeConstr)
    offsets = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
...
class Torch_AtenPowTensorTensorOp(IRDLOperation):
    ...
    self = operand_def(AnyTensorTypeConstr)
    exponent = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
...
class Torch_AtenFillTensorOp(IRDLOperation):
    ...
    self = operand_def(AnyTensorTypeConstr)
    value = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
    assembly_format = (
...
class Torch_AtenWhereSelfOp(IRDLOperation):
    ...
    condition = operand_def(AnyTensorTypeConstr)
    self = operand_def(AnyTensorTypeConstr)
    other = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
...
class Torch_AtenFrexpTensorOp(IRDLOperation):
    ...
    self = operand_def(AnyTensorTypeConstr)
    mantissa = result_def(AnyTensorTypeConstr)
    exponent = result_def(AnyTensorTypeConstr)
    assembly_format = (
...
class Torch_AtenMmOp(IRDLOperation):
    name = "torch.aten.mm"
    self = operand_def(AnyTensorTypeConstr)
    mat2 = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
    assembly_format = (
...
class Torch_AtenTanhBackwardOp(IRDLOperation):
    ...
    grad_output = operand_def(AnyTensorTypeConstr)
    output = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
...
class Torch_AtenTanhBackwardGradInputOp(IRDLOperation):
    ...
    grad_output = operand_def(AnyTensorTypeConstr)
    output = operand_def(AnyTensorTypeConstr)
    grad_input = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
...
class Torch_Aten_PreluKernelOp(IRDLOperation):
    ...
    self = operand_def(AnyTensorTypeConstr)
    weight = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
...
class Torch_Aten_PreluKernelBackwardOp(IRDLOperation):
    ...
    self = operand_def(AnyTensorTypeConstr)
    weight = operand_def(AnyTensorTypeConstr)
    result0 = result_def(AnyTensorTypeConstr)
    result1 = result_def(AnyTensorTypeConstr)
...
class Torch_AtenLogSigmoidBackwardOp(IRDLOperation):
    ...
    grad_output = operand_def(AnyTensorTypeConstr)
    self = operand_def(AnyTensorTypeConstr)
    buffer = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
...
class Torch_Aten_EuclideanDistOp(IRDLOperation):
    ...
    x1 = operand_def(AnyTensorTypeConstr)
    x2 = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
    assembly_format = (
...
class Torch_AtenLogSigmoidForwardOp(IRDLOperation):
    ...
    self = operand_def(AnyTensorTypeConstr)
    output = result_def(AnyTensorTypeConstr)
    buffer = result_def(AnyTensorTypeConstr)
    assembly_format = (
...
class Torch_AtenMvOp(IRDLOperation):
    name = "torch.aten.mv"
    self = operand_def(AnyTensorTypeConstr)
    vec = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
    assembly_format = (
...
class Torch_AtenTakeOp(IRDLOperation):
    ...
    self = operand_def(AnyTensorTypeConstr)
    index = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
    assembly_format = (
...
class Torch_AtenHeavisideOp(IRDLOperation):
    ...
    self = operand_def(AnyTensorTypeConstr)
    values = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
...
class Torch_AtenXlogyOuttensorOp(IRDLOperation):
    ...
    self = operand_def(AnyTensorTypeConstr)
    other = operand_def(AnyTensorTypeConstr)
    out = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
...
class Torch_AtenClampMinTensorOp(IRDLOperation):
    ...
    self = operand_def(AnyTensorTypeConstr)
    min = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
    assembly_format = (
...
class Torch_AtenClampMaxTensorOp(IRDLOperation):
    ...
    self = operand_def(AnyTensorTypeConstr)
    max = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
    assembly_format = (
...
class Torch_AtenLerpTensorOp(IRDLOperation):
    ...
    self = operand_def(AnyTensorTypeConstr)
    end = operand_def(AnyTensorTypeConstr)
    weight = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
...
class Torch_AtenDotOp(IRDLOperation):
    name = "torch.aten.dot"
    self = operand_def(AnyTensorTypeConstr)
    tensor = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
...
class Torch_AtenComplexOp(IRDLOperation):
    ...
    real = operand_def(AnyTensorTypeConstr)
    imag = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
    assembly_format = (
...
class Torch_AtenPolarOp(IRDLOperation):
    ...
    abs = operand_def(AnyTensorTypeConstr)
    angle = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
    assembly_format = (
...
class Torch_AtenSpecialSphericalBesselJ0Op(IRDLOperation):
    ...
    x = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
...
class Torch_AtenLinalgEigOp(IRDLOperation):
    ...
    self = operand_def(AnyTensorTypeConstr)
    eigenvalues = result_def(AnyTensorTypeConstr)
    eigenvectors = result_def(AnyTensorTypeConstr)
...
class Torch_AtenLinalgHouseholderProductOp(IRDLOperation):
    ...
    input = operand_def(AnyTensorTypeConstr)
    tau = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
    assembly_format = (
...
class Torch_Aten_LinalgSlogdetOp(IRDLOperation):
    ...
    A = operand_def(AnyTensorTypeConstr)
    sign = result_def(AnyTensorTypeConstr)
    logabsdet = result_def(AnyTensorTypeConstr)
    LU = result_def(AnyTensorTypeConstr)
    pivots = result_def(AnyTensorTypeConstr)
...
class Torch_AtenAdaptiveMaxPool2DBackwardOp(IRDLOperation):
    ...
    grad_output = operand_def(AnyTensorTypeConstr)
    self = operand_def(AnyTensorTypeConstr)
    indices = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
...
class Torch_Aten_WeightInt8PackMmOp(IRDLOperation):
    ...
    self = operand_def(AnyTensorTypeConstr)
    mat2 = operand_def(AnyTensorTypeConstr)
    scales = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
...
class Torch_AtenSpecialChebyshevPolynomialTOp(IRDLOperation):
    ...
    x = operand_def(AnyTensorTypeConstr)
    n = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
...
class Torch_Profiler_RecordFunctionExitOp(IRDLOperation):
    ...
    _0 = operand_def(AnyTensorTypeConstr)
...
class Torch_InductorAccumulateGrad_Op(IRDLOperation):
    ...
    variable = operand_def(AnyTensorTypeConstr)
    new_grad = operand_def(AnyTensorTypeConstr)
...
class Torch_PrimsWhereOp(IRDLOperation):
    ...
    pred = operand_def(AnyTensorTypeConstr)
    a = operand_def(AnyTensorTypeConstr)
    b = operand_def(AnyTensorTypeConstr)
    result = result_def(AnyTensorTypeConstr)
